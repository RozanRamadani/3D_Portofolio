...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await emailjs.send('service_2q6mdzq',
                'template_wjsb9hr',
                {
                    from_name: form.name,
                    to_name: 'Rozan',
                    from_email: form.email,
                    to_email: 'rozanaiman42@gmail.com',
                ...
                <div className="contact-container">
                    ...
                    <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col space-y-7">
                        ...
                        <label className="space-y-3">
                            ...
                            <textarea name="message" value={form.message} onChange={handleChange} required rows={5} className="field-input" placeholder="Type your message here..." />
                        </label>
